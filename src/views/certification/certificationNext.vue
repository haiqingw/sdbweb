<template>
  <div>
    ...
    <div class="certificationMain">
      <h3>绑定结算卡</h3>
      <p>
        为有效保障您的资金安全，请填写与您身份证一致的信息，否则不会通过审核！
      </p>
      ...
      <div class="itemTopTextMain">
        ...
        <div class="line_bottom">
          <input
            type="text"
            placeholder="请填写银行卡号"
            v-model="queryData.bindCardCer.cardNum"
            @blur="getBankName"
          />
        </div>
      </div>
      ...
      <div class="itemTopTextMain">
        ...
        <div class="line_bottom">
          <input
            ...
            maxlength="11"
            v-model="queryData.bindCardCer.phone"
          />
        </div>
      </div>
      <div class="submitBtnMain">
        <mt-button type="primary" size="large" @click="submitModification"
          >确认提交</mt-button
        >
      </div>
    </div>
