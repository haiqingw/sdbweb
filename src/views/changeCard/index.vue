<template>
  <div>
    ...
    <!-- body -->
    <div class="tipMain">
      <img src="@/assets/images/tipIcon.png" alt="提示" />
      请添加本人储蓄卡信息，认真填写核对
    </div>
    <div class="changeCardMain">
      ...
      <div class="iconInputItem line_bottom">
        ...
        <input
          type="tel"
          placeholder="请输入银行卡号"
          v-model="queryData.bankNameData.cardNum"
          @blur="getBankName"
        />
      </div>
      <div class="iconInputItem line_bottom">
      ...
      <div class="iconInputItem line_bottom">
        ...
        <input
          ...
          v-model="queryData.modifyData.phone"
        />
      </div>
      <div class="submitBtnMain">
        <mt-button type="primary" size="large" @click="submitModify"
          >确定提交</mt-button
        >
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getBankName() {
      if (
        this.queryData.bankNameData.cardNum != "" &&
    ...
    submitModify() {
      ...
      if (
        this.queryData.modifyData.phone == "" ||
        this.queryData.modifyData.phone == undefined
      ) {
        Toast({
          message: "请输入银行预留手机号",
          duration: 2000
      ...
      this.queryData.modifyData.cardNum = this.queryData.bankNameData.cardNum; 
