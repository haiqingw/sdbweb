    ...
    <div>
        ...
        <div class="certificationMain">
            ...
            <div class="submitBtnMain">
                <mt-button type="primary" size="large" @click="AccountWriteOff">账号注销</mt-button>
            </div>
        </div>
    </div>
</template>
        ...
        AccountWriteOff() {
            ...
            if (this.flag) {
                if (
                    ...
                    MessageBox.confirm("您确定要注销账号吗?", "账号注销")
                        .then(action => {
                            this.$store
                                .dispatch(
                                    "Cancellation",
                                    this.queryData.AccountWriteOff
                                )
                                .then(() => {
                                    setTimeout(() => {
                                        setTimeout(() => {
